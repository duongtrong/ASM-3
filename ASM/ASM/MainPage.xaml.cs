    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void Handle_Signup(object sender, RoutedEventArgs e)
        {
            ...
            if (this.Email.Text == "")
            {
                ...
                this.Email_Message.Text = "Please enter introduction";
            }
            if (this.Password.ToString() == "")
            {

                this.Password_Message.Text = "Please enter introduction";
            }
            if (this.FirstName.Text == "")
            {

                this.First_Message.Text = "Please enter introduction";
            }
            if (this.LastName.Text == "")
            {

                this.LastName.Text = "Please enter introduction";
            }
            ...
            if (this.Address.Text == "")
            {
                ...
                this.Address_Message.Text = "Please enter introduction";
            }
            if (this.Phone.Text == "")
            {

                this.Phone_Message.Text = "Please enter introduction";
            }
